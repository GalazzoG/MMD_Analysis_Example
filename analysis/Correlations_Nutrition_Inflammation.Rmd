...
# The 'here' function allows the use of paths relative to the project directory
...
nutrients.cor<-Nutrients%>%
  ...
  dplyr::rename("nutr_flavan_3_ol"="nutr_flavan-3-ol") # replacing - with _ to avoid errors
